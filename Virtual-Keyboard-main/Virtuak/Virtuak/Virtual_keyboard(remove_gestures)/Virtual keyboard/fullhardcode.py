...
# Add special keys
keys.append(Key(startX, startY + 3 * h + 15, 5 * w + 20, h, "Space"))
keys.append(Key(startX + 6 * (w + 5), startY + 3 * h + 15, 5 * w + 20, h, "<--"))
keys.append(Key(startX + 12 * (w + 5), startY + 3 * h + 15, 5 * w + 20, h, "Enter"))
...
while True:
    ...
    if show:
        ...
        # Handle typing actions (already handled via key presses above)
